...
<style>
  /* Scoped to this page's wrapper so it won't fight your other pages */
  ...
  .gr-page {
    ...
    --ink-soft: #4A423A;
    --meta: #756B5E;
    --accent: #6B3F2A;      /* warm walnut brown, not the usual terracotta/cream combo */
    --rule: #DCD3C2;
  ...
  .gr-nav a:hover { color: var(--accent); border-bottom-color: var(--accent); }
...
<div class="gr-layout">
    ...
    <div class="gr-side">
      ...
      <div class="gr-contact">
        <h2>Contact &amp; Links</h2>
        <ul>
          <li class="gr-email"><strong>Email:</strong> g.razzu@reading.ac.uk</li>
          <li><a href="https://scholar.google.com/citations?user=bZBFpUcAAAAJ&hl=en">Google Scholar</a></li>
          <li><a href="https://orcid.org/my-orcid?orcid=0000-0003-2640-8314">ORCID</a></li>
          <li><a href="https://ideas.repec.org/f/pra798.html">IDEAS / RePEc</a></li>
          <li><a href="https://www.researchgate.net/profile/Giovanni-Razzu">ResearchGate</a></li>
