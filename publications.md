...
<style>
  ...
  .gr-cat:first-of-type { margin-top: 0; }

  .pub { padding: 14px 0; border-bottom: 1px solid #EEE7D8; }
  ...
  .pub-authors { color: var(--ink-soft); font-size: 0.94rem; padding-left: 1.3em; margin: 0 0 2px; }
  .pub-venue { color: var(--meta); font-size: 0.9rem; font-style: italic; padding-left: 1.3em; margin: 0; }
</style>
...
<div class="gr-page">
  ...
  <nav class="gr-nav">
    ...
    <a href="https://giovannirazzu.github.io/publications.html" class="active">Publications</a>
  ...
  <h2 class="gr-page-title">Publications</h2>
  <p class="gr-page-intro">Papers currently under review are listed on the <a href="https://giovannirazzu.github.io/work in progress.html">Work in Progress</a> page instead.</p>

  <div class="gr-cat">Journal Articles</div>

  <div class="pub">
    <p class="pub-title"><a href="https://dx.doi.org/10.1016/j.euroecorev.2026.105271">Gender Stereotypes, Language and Performance</a></p>
    <p class="pub-authors">Marina Della Giusta, Sylvia Jaworska, Almudena Sevilla, and <strong>Giovanni Razzu</strong></p>
    <p class="pub-venue">European Economic Review, vol. 184, 2026</p>
  </div>
